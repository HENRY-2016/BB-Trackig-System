      ...
      <div id="page-content-wrapper">
         ...
         <label class="page-title-label" >Club | Members | Product </label>
               ...
               <div id="quick-links-div-2">
                  ...
                  @endif
               <form method="post" action="{{route('TenantsCrud.update',$data->id)}}" enctype="multipart/form-data" >
                     {{ csrf_field() }}
                     {{ method_field('PATCH') }}
                     <div class="my-grid-container">
                     <div class="my-grid-item">
								<label class="input-labels" >Full Name</label><br>
                        <input  required type="text" class="form-control"  value="{{$data->FName}}" name="FName" placeholder="F Name"  autocomplete="off">
							</div>

								
                     <div class="my-grid-item">
								<label class="input-labels" >Contact</label><br>
                        <input  required type="text"  value="{{$data->Contact}}" class="form-control" name="Contact" placeholder="Contact"  autocomplete="off">
							</div>

                     <div class="my-grid-item">
                        <label class="input-labels" >Building</label><br>
                        <select  class="form-control"   name="Building">
                           <option >{{$data->Building}} </option>
                           <option></option>
                     ...
                     <div class="my-grid-item">
                        <label class="input-labels" >Room</label><br>
                        <select  class="form-control"   name="RoomNo">
                           <option >{{$data->RoomNo}} </option>
                           <option></option>
                     ...
                     <div class="my-grid-item">
                        ...
                        <input  required type="text" class="form-control" value="{{$data->Amount}}" name="Amount" placeholder="Amount"  autocomplete="off">
							</div>

                     <div class="my-grid-item">
								<label class="input-labels" >Date</label><br>
                        <input required type="date" value="{{$data->Date}}" class="form-control" name="Date" required  autocomplete="off">
							</div>

                     <div class="my-grid-item">
								<label class="input-labels" >Staff</label><br>
                        <input  required type="text"  value="{{$data->StaffName}}" class="form-control" name="StaffName" placeholder="Staff"  autocomplete="off">
							</div>

                     <div class="my-grid-item">
								<label class="input-labels" >Image:</label><br>
                        <img src="{{URL::to('/')}}/images/{{$data->Image}}" class="img-thumbnail" width="100" />
							</div>
                     <div class="my-grid-item">
								<label class="input-labels" >New Image:</label>
